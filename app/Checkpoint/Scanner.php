...
final class Scanner
{
    ...
    public function only(array $only): static
    {
        ...
        $this->checks = array_values(array_filter(
            $this->checks,
            fn (AbstractCheck $check): bool => in_array(mb_strtolower($check->name()), $whitelist, true),
        ));
    ...
    public function except(array $skip): static
    {
        ...
        $this->checks = array_values(array_filter(
            $this->checks,
            fn (AbstractCheck $check): bool => ! in_array(mb_strtolower($check->name()), $blacklist, true),
        ));
